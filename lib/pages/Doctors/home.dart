    ...
    return BlocConsumer<cubit, States>(
        builder: (context, state) {
          return ConditionalBuilder(
              condition: state is! LoadingGetAllPatients,
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.separated(
                                  ...
                                  itemBuilder: (context, index) => Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              "Name is :  ${cubit.get(context).allPatients[index].name}"),
                                          SizedBox(
                                            height: 20,
                                          ),
                                          Text(
                                              "Age is :  ${cubit.get(context).allPatients[index].age}"),
                                          SizedBox(
                                            height: 20,
                                          ),
                                          Text(
                                              "Phone is :  ${cubit.get(context).allPatients[index].phone}"),
                                          SizedBox(
                                            height: 20,
                                          ),
                                        ],
                                  ...
                                  itemCount:
                                      cubit.get(context).allPatients.length,
                                ),
                              ],
                            ),
                          ),
